package cc.nsqd.ccemuxplugins.tomsperipherals.cc;
...
public class CCComputer implements IComputer {
	...
	@Override
	public Object[] pullEvent(String string) throws TMLuaException {
		/*try {
	...
	public static dan200.computercraft.api.lua.LuaException toLuaException(TMLuaException ex){
