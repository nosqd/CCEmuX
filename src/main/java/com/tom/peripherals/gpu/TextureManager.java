...
public class TextureManager {
	...
	public int genTextureID(Object[] a) throws TMLuaException {
	...
	public void deleteTextures(Object[] a) throws TMLuaException {
		if (a.length == 0) throw new TMLuaException("Too few arguments: number texture ids...");
	...
	public void bindTexture(Object[] a) throws TMLuaException {
		if (a.length == 0) throw new TMLuaException("Too few arguments: number id");
		int id = ParamCheck.getInt(a, 0);
		boundTexture = textureMap.get(id);
	}

	public void texImage(Object[] a) throws TMLuaException {
		if (a.length < 1) throw new TMLuaException("Too few arguments: image ref or number width, numbers texture...");
		if (boundTexture == null) throw new TMLuaException("No bound texture");
