...
public class VRAM {
	...
	public void checkSizeEx(long size) throws TMLuaException {
		if (!checkSize(size))throw new TMLuaException("Alloc failed: Out of VRAM");
	}
	...
	public void allocEx(VRAMObject o, long size) throws TMLuaException {
		if (!tryAlloc(o, size))throw new TMLuaException("Alloc failed: Out of VRAM");
	}
	...
	public void reallocEx(VRAMObject o, long size) throws TMLuaException {
		if (!realloc(o, size))throw new TMLuaException("Realloc failed: Out of VRAM");
	}
