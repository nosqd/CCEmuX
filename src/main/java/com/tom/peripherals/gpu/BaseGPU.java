...
import cc.nsqd.ccemuxplugins.tomsperipherals.WindowGPUContextWithFrames;
import cc.nsqd.ccemuxplugins.tomsperipherals.awt.WindowFrameContext;
...
public class BaseGPU extends TMLuaObject {
	...
	public static interface GPUContext {
		...
		void sync() throws TMLuaException;
	...
	@TMLuaMethod
	public boolean fill(Object[] a) throws TMLuaException {
		int color;
		if (a.length == 0) {
			color = 0x000000;
		} else {
	...
	@TMLuaMethod
	public boolean filledRectangle(Object[] a) throws TMLuaException {
		int color;
		if (a.length < 4) {
			throw new TMLuaException("Too few arguments (expected x,y,width,height,[color])");
		}
		if (a.length < 5) {
			color = 0x000000;
		} else {
	...
	@TMLuaMethod
	public boolean rectangle(Object[] a) throws TMLuaException {
		int color;
		if (a.length < 4) {
			throw new TMLuaException("Too few arguments (expected x,y,width,height,[color])");
		}
	...
	@TMLuaMethod
	public boolean line(Object[] a) throws TMLuaException {
		int color;
		if (a.length < 4) {
			throw new TMLuaException("Too few arguments (expected x1,y1,x2,y2,[color])");
		}
		if (a.length < 5) {
			color = 0x000000;
		} else {
	...
	@TMLuaMethod
	public boolean lineS(Object[] a) throws TMLuaException {
		int color;
		if (a.length < 4) {
			throw new TMLuaException("Too few arguments (expected x1,y1,x2,y2,[color])");
		}
	...
	@TMLuaMethod
	public boolean drawText(Object[] a) throws TMLuaException {
		if (a.length < 3) {
			throw new TMLuaException(
		...
		if (a.length > 2 && a[0] instanceof Double && a[1] instanceof Double && a[2] != null) {
			...
			if (x < 0 || (l + x) > ctx.getWidth()) {
				throw new TMLuaException("Out of boundary x " + x + ":" + (l + x));
			}
			if (y < 0 || (y + selectedFont.fontHeight) > ctx.getHeight()) {
				throw new TMLuaException("Out of boundary y");
			}
			int wx = x;
			try {
	...
	@TMLuaMethod
	public boolean setFont(Object[] a) throws TMLuaException {
		if (a.length > 0) {
			Font f = FontManager.getOrLoadFont(ctx.getVRam().getIntFonts(), ParamCheck.getString(a, 0));
			if (f != null) selectedFont = f;
			return true;
		} else throw new TMLuaException("Invalid Arguments, excepted (string font_name)");
	}

	@TMLuaMethod
	public int getTextLength(Object[] a) throws TMLuaException {
		...
		} else throw new TMLuaException("Invalid Arguments, excepted (string text, [number size], [number padding])");
	}

	@TMLuaMethod
	public boolean drawTextSmart(Object[] a) throws TMLuaException {
		if (a.length < 3) {
			throw new TMLuaException(
		...
		if (x < 0 || (l + x) > ctx.getWidth()) {
			throw new TMLuaException("Out of boundary x");
		}
		if (y < 0 || (y + selectedFont.fontHeight) > ctx.getHeight()) {
			throw new TMLuaException("Out of boundary y");
		}
	...
	@TMLuaMethod
	public boolean setFontDefaultCharID(Object[] a) throws TMLuaException {
		if (!selectedFont.editable()) throw new TMLuaException("Selected font is not modifiable");
		if (a.length > 0) {
			int id = ParamCheck.getInt(a, 0) - 1;
			if (id < 0) throw new TMLuaException("Bad Argument #1, (too small number (" + id + ") minimum value is 1 )");
			if (id > 255)
				throw new TMLuaException("Bad Argument #1, (too big number (" + id + ") maximum value is 256 )");
			selectedFont.UNKNOWN = id;
			return true;
		} else {
			throw new TMLuaException("Invalid Arguments, excepted (number id)");
		}
	}
	...
	@TMLuaMethod
	public int addNewChar(Object[] a) throws TMLuaException {
		if (!selectedFont.editable()) throw new TMLuaException("Selected font is not modifiable");
		if (a.length > 17) {
			String c = ParamCheck.getString(a, 0);
			if (c.length() != 1) throw new TMLuaException("Bad Argument #1 a sigle character expected");
			int[] d = ParamCheck.ints(a, 1).toArray();
			if (d.length != 17)
				throw new TMLuaException("Invalid arguments, expected (string char, number width, 16 x number char_data)");
			return selectedFont.addChar(c, d);
		} else throw new TMLuaException("Invalid arguments, expected (string char, number width, 16 x number char_data)");
	}

	@TMLuaMethod
	public boolean delChar(Object[] a) throws TMLuaException {
		if (!selectedFont.editable()) throw new TMLuaException("Selected font is not modifiable");
		if (a.length > 0 && a[0] != null) {
			String c = ParamCheck.getString(a, 0);
			if (c.length() != 1) throw new TMLuaException("Bad Argument #1 a sigle character expected");
			...
			return true;
		} else throw new TMLuaException("Invalid arguments, expected (string char)");
	}
	...
	@TMLuaMethod
	public boolean clearChars() throws TMLuaException {
		selectedFont.clear();
		return true;
	}

	@TMLuaMethod
	public boolean drawChar(Object[] a) throws TMLuaException {
		if (a.length < 3) {
			throw new TMLuaException(
	...
	@TMLuaMethod
	public boolean drawBuffer(Object[] a) throws TMLuaException {
		if (a.length < 4) {
			throw new TMLuaException(
	...
	@TMLuaMethod
	public boolean drawImage(Object[] a) throws TMLuaException {
		if (a.length < 3) {
			throw new TMLuaException(
		...
		if (!(ctx.getVRam().getRefMngr().getByReference(ParamCheck.getString(a, 2)) instanceof LuaImage li))
			throw new TMLuaException("Invalid reference");
	...
	@TMLuaMethod
	public Object createWindow(Object[] a) throws TMLuaException {
		Rect r = Rect.parseRect(a);
		WindowGPUContextWithFrames c = new WindowGPUContextWithFrames(ctx, r);
		WindowFrameContext ec = new WindowFrameContext(c);
		c.addFrameContext(ec);
		return new BaseGPU(c);
	}

	@TMLuaMethod
	public Object createWindow3D(Object[] a) throws TMLuaException {
		Rect r = Rect.parseRect(a);
		WindowGPUContextWithFrames c = new WindowGPUContextWithFrames(ctx, r);
		WindowFrameContext ec = new WindowFrameContext(c);
		c.addFrameContext(ec);
